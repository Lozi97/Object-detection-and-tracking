...
Object_tracking(yolo, video_path, "detection.mp4", input_size=YOLO_INPUT_SIZE, show=True, iou_threshold=0.5, rectangle_colors=(255,0,0), Track_only = ["person","bus","car","motorbike","truck"])
